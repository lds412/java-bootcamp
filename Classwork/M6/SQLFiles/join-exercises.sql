...
-- 9 rows
--------------------
-- Already written with aliases. See above. 
...
INNER JOIN ExerciseCategory p ON c.ParentCategoryId = p.ExerciseCategoryId;
...
WHERE l.Name = 'Beginner' AND c.FirstName = 'Shell' AND c.LastName = 'Creane';
